from flask import Flask, render_template, url_for, request, make_response, flash, redirect, Response
...
app.config['SECRET_KEY'] = 'my-scret-key'
db = SQLAlchemy(app)
